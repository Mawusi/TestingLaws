...
<div class="container-fluid" style="margin-bottom: 5em;"> 
    ...
    <div id="my-tab-content" class="tab-content">
        ...
        <div id="tableOfContentTab" class="tab-pane fade in active">
            ...
            <div class="row">
                <div class="col-md-6">
                   <h5><b>{{ $nlcDecree['title'] }}</b></h5>
                   <hr><hr>
                   <a data-scroll-to="#main_nlc"
                      data-scroll-focus="#main_nlc"
                      data-scroll-speed="400"
                      data-scroll-offset="-50" class="preamble_link" id="preamble_link_toggle" href="/pre_1992_legislation/nlc-preamble/{{ $nlcDecree['id'] }}">
                      <p>Introductory Text</p>
                   </a>
                   
                    
                        @include('pre_1992_nlc.nlcContentDisplay')
        ...
        <div id="contentTab" class="tab-pane fade">
          <div class="row">
              ...
              @include('pre_1992_nlc.container_details_nlc')
          </div>   
