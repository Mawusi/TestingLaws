...
<div class="col-md-2"> 
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        {{-- View all sections --}}
        <div class="btn-group">
              <button type="button" class="btn btn-default">All 1st Republic section</button>
              ...
              <ul class="dropdown-menu table-wrapper-scroll-view">
                ...
                <li><a class="view_all_section_link" href="/pre_1992_legislation/first-republic-content/{{ $firstArticle->id }}">{{$firstArticle->section }}</a></li>
                {{-- <li role="separator" class="divider" style="width:600px"></li> --}}
                @endforeach
                {{-- <a href=""><li style="list-style: none;">Whole Act (PDF)</li></a>
                <a href=""><li style="list-style: none;">Current Section(PDF)</li></a> --}}        
