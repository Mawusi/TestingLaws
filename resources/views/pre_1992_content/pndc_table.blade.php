...
<div class="container-fluid" style="margin-bottom: 5em;"> 
    ...
    <div id="my-tab-content" class="tab-content">
        ...
        <div id="tableOfContentTab" class="tab-pane fade in active">
            ...
            <div class="row">
                <div class="col-md-6">
                   <h5><b>{{ $pndcLaw['title'] }}</b></h5>
                   <hr><hr>
                   <a data-scroll-to="#main_pndc"
                      data-scroll-focus="#main_pndc"
                      data-scroll-speed="400"
                      data-scroll-offset="-50" class="preamble_link" id="preamble_link_toggle" href="/pre_1992_legislation/pndc-preamble/{{ $pndcLaw['id'] }}">
                      <p>Introductory Text</p>
                   </a>
                   
                    
                        @include('pre_1992_content.pndcContentDisplay')
        ...
        <div id="contentTab" class="tab-pane fade">
          <div class="row">
              ...
              @include('pre_1992_content.container_details_pndc')
          </div>   
