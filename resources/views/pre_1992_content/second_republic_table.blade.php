...
@include('layouts.second_republic')
            ...
            <div class="row">
                <div class="col-md-6">
                   ...
                   <a data-scroll-to="#main_second_republic"
                      ...
                      data-scroll-offset="-50" class="preamble_link" id="preamble_link_toggle" href="/pre_1992_legislation/second-republic-preamble/{{ $allsecondRepublic['id'] }}">
