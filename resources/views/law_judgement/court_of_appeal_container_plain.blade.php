...
<div class="col-md-2"> 
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        {{-- View all sections --}}
        <div class="btn-group">
              <button type="button" class="btn btn-default">All Court of Appeal Cases</button>
              ...
              <ul class="dropdown-menu scroll-view-judgement">
                @foreach($courtOfAppeals as $courtOfAppeal)
                  <li><a class="view_all_section_link" href="/judgement/court-of-appeal-case-view/{{ $courtOfAppeal->id }}">{{$courtOfAppeal->case_title }}</a></li>
                 @endforeach 
                 <br> 
              </ul>
        </div>
