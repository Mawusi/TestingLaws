...
<div class="col-md-2"> 
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        {{-- View all sections --}}
        <div class="btn-group">
              <button type="button" class="btn btn-default">View All International Cases</button>
              ...
              <ul class="dropdown-menu scroll-view-judgement">
                @foreach($internationalCases as $internationalCase)
                  <li><a class="view_all_section_link" href="/judgement/international-case-view/{{ $internationalCase->id }}">{{$internationalCase->case_title }}</a></li>
                 @endforeach 
                 <br> 
              </ul>
        </div>
