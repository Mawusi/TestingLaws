...
<div class="col-md-2"> 
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        {{-- View all sections --}}
        <div class="btn-group">
              <button type="button" class="btn btn-default">All Supreme Court Cases</button>
              ...
              <ul class="dropdown-menu scroll-view-judgement">
                @foreach($supremeCourts as $supremeCourt)
                  <li><a class="view_all_section_link" href="/judgement/supreme-court-case-view/{{ $supremeCourt->id }}">{{$supremeCourt->case_title }}</a></li>
                 @endforeach 
                 <br> 
              </ul>
        </div>
