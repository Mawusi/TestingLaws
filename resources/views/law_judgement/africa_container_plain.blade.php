...
<div class="col-md-2"> 
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        {{-- View all sections --}}
        <div class="btn-group">
              <button type="button" class="btn btn-default">All Africa Court Cases</button>
              ...
              <ul class="dropdown-menu scroll-view-judgement">
                @foreach($africaJudgements as $africaJudgement)
                  <li><a class="view_all_section_link" href="/judgement/Africa/Case-view/{{ $africaJudgement->country }}/{{ $africaJudgement->id}}">{{$africaJudgement->case_title }}</a></li>
                 @endforeach 
                 <br> 
              </ul>
        </div>
