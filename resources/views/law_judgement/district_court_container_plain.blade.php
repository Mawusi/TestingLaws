...
<div class="col-md-2"> 
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        {{-- View all sections --}}
        <div class="btn-group">
              <button type="button" class="btn btn-default">View All District Court Cases</button>
              ...
              <ul class="dropdown-menu scroll-view-judgement">
                @foreach($districtCourts as $districtCourt)
                  <li><a class="view_all_section_link" href="/judgement/district-court-case-view/{{ $districtCourt->id }}">{{$districtCourt->case_title }}</a></li>
                 @endforeach 
                 <br> 
              </ul>
        </div>
