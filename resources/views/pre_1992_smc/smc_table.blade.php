...
<div class="container-fluid" style="margin-bottom: 5em;"> 
    ...
    <div id="my-tab-content" class="tab-content">
        ...
        <div id="tableOfContentTab" class="tab-pane fade in active">
            ...
            <div class="row">
                <div class="col-md-6">
                   <h5><b>{{ $smcDecree['title'] }}</b></h5>
                   <hr><hr>
                   <a data-scroll-to="#main_smc"
                      data-scroll-focus="#main_smc"
                      data-scroll-speed="400"
                      data-scroll-offset="-50" class="preamble_link" id="preamble_link_toggle" href="/pre_1992_legislation/smc-preamble/{{ $smcDecree['id'] }}">
                      <p>Introductory Text</p>
                   </a>
                   
                    
                        @include('pre_1992_smc.smcContentDisplay')
        ...
        <div id="contentTab" class="tab-pane fade">
          <div class="row">
              ...
              @include('pre_1992_smc.container_details_smc')
          </div>   
