...
<div class="col-md-12"> 
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        {{-- View all sections --}}
        <div class="btn-group">
              <button type="button" class="btn btn-default">All Regulation Sections</button>
              ...
              <ul class="dropdown-menu table-wrapper-scroll-view">
                ...
                @foreach($regulationContents as $title)
                <li><a href="/post_1992_legislation/regulation-content/{{ $title->id }}" class="single_view_all_regulation_section_link">{{ $title->section }}</a></li>
                @endforeach
