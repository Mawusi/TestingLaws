            ...
            <div class="col-md-8">
                <div class="list-group">
                    <table class="table table-striped table-condensed" id="datatable">
                        ...
                        <tr>
                            <td>{{ $europeConstitution->name }}</td>
                            <td>
                                <a href="/constitution/all-countries/act-title/{{ $europeConstitution->id }}"><li style="list-style: none;">{{ $europeConstitution->constitution_name }}</li></a>
                            </td>
